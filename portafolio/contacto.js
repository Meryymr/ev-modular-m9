...
inputNombre.setCustomValidity("");
            ...
            if (!regexNombre.test(inputNombre.value.trim())) {
                ...
                errorNombre.textContent = "Por favor, ingresa tu nombre y apellido (solo letras).";
            ...
            if (!regexEmail.test(inputEmail.value.trim())) {
                ...
                errorEmail.textContent = "Por favor, ingresa una dirección de correo válida (ejemplo@dominio.com).";
                formularioValido = false;
            } else {
                inputEmail.setCustomValidity("");
            }
            ...
            if (formularioValido && this.checkValidity()) {
                alert('¡Muchas gracias por tu mensaje!, pronto me pondré en contacto contigo');
